      ...
      <body style={{ margin: 0, fontFamily: "Syne, sans-serif", background: "#f9f9f7", color: "#0f1f14" }}>
        ...
        <div className="page-scrollable" style={{ maxWidth: 640, margin: "0 auto", padding: "48px 24px 80px" }}>
          ...
          <div style={{ marginBottom: 32 }}>
            ...
            <p style={{ ...p, fontSize: 12, marginBottom: 0 }}>Last updated: May 2026</p>
          </div>
          ...
          <p style={{ ...p, marginBottom: 8 }}>We use your email address exclusively to:</p>
          <ul style={{ ...p, paddingLeft: 20, marginTop: 0 }}>
            <li style={li}>Send you a magic link to sign in</li>
            <li style={li}>Sync your scripts across your devices</li>
            <li style={li}>Respond to support requests you send us</li>
          </ul>

          <h2 style={h2}>Data storage and security</h2>
          <p style={p}>
            Pro user data is stored on{" "}
            <a href="https://supabase.com" target="_blank" rel="noopener noreferrer" style={{ color: "#16a34a" }}>Supabase</a>,
            hosted in Ireland (EU West), compliant with GDPR. Data is encrypted in transit (TLS) and at rest. Row-level security ensures each user can only access their own data.
          </p>
          ...
          <ul style={{ ...p, paddingLeft: 20, marginTop: 0 }}>
            <li style={li}><strong>reelprompt:scripts</strong> — your scripts, stored locally on your device</li>
            <li style={li}><strong>reelprompt:settings</strong> — your teleprompter preferences, stored locally</li>
            <li style={li}><strong>reelprompt:pro</strong> — your Pro activation status, stored locally</li>
            <li style={li}><strong>reelprompt:cookies</strong> — records that you acknowledged this banner</li>
            <li style={li}><strong>Supabase auth cookies</strong> — session tokens used to keep you signed in across devices (Pro only)</li>
          </ul>
          <p style={p}>
          ...
          <ul style={{ ...p, paddingLeft: 20, marginTop: 0 }}>
            <li style={li}><strong>Supabase</strong> — authentication and database (Ireland, EU)</li>
            <li style={li}><strong>Vercel</strong> — hosting and CDN</li>
            <li style={li}><strong>Ko-fi</strong> — payment processing for Pro access (no payment data is stored by ReelPrompt)</li>
            <li style={li}><strong>Resend</strong> — transactional email for magic links and support replies</li>
          </ul>
          ...
          <ul style={{ ...p, paddingLeft: 20, marginTop: 0 }}>
            ...
            <li style={li}>Export your data</li>
