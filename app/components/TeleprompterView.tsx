...
import { IconBack, IconSettings, IconPlay, IconPause, IconDownload, IconReset, IconMirror } from "./Icons";
...
export default function TeleprompterView({ script, settings, onSettingsChange, onBack }: Props) {
  ...
  // Text shadow — always strong base + extra stroke option
  ...
  const textBgStyle: React.CSSProperties =
    settings.textBackground === "band"
      ...
      : settings.textBackground === "full"
      ? { background: "transparent" }   // handled by overlay below
      : {};

  return (
    /* ── Outer shell: fills screen, centres the 9:16 box ── */
    <div style={{
      ...
      >
        ...
        {camera.hasPermission === false && (
          <div style={{
            ...
            <p style={{ fontSize: 18, fontWeight: 700, textAlign: "center", marginBottom: 8 }}>Camera access needed</p>
        ...
        {/* Full overlay for "full" text background mode */}
        ...
        {!isDone && countdown === null && (
          <div style={{
            ...
            <div className="focus-line" style={{
              ...
              top: "35%", height: "30%", pointerEvents: "none",
            }} />
            ...
            >
              <div style={{
                ...
                <div
                  ...
                  // Rich HTML from editor — user-authored, safe
        ...
        {isDone && (
          <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12, width: "100%", maxWidth: 320 }}>
              ...
              <button className="btn btn-ghost" style={{ width: "100%", borderColor: "transparent" }}
                onClick={onBack}>
                Back to Scripts
              </button>
            </div>
            ...
            <div style={{
              ...
              {(isIdle || scroll.isFinished) && (
                <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                  <button className="btn btn-icon"
                    ...
                    onClick={scroll.reset}><IconReset /></button>
                  <button style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
                {isIdle && countdown === null && (
                  <button onClick={handleStartWithCountdown} style={{
                ...
                {(isRecording || isPaused) && (
                  <>
                    <button onClick={scroll.toggle} style={{
              ...
              <div style={{
                ...
                <input type="range" min={1} max={10} step={0.5} value={settings.speed}
                  onChange={(e) => {
                    const s = { ...settings, speed: Number(e.target.value) };
                    onSettingsChange(s); saveSettings(s);
                  }}
